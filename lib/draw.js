...
function createNumberSVGs(order,coordsObject,id,classes) {
  ...
  return `<svg id='numbers-${order}-${id}' class='order-xt pad ${classes}' viewBox='${0} ${-50} ${w-sizeInc+50+30} ${w-sizeInc+50+20}'>${texts}</svg>`;
}
...
function createPolyline(order,coordsObject,id,classes) {
  ...
  return `<svg id='straight-${order}-${id}' class='order-x pad ${classes} l${totalLength}' viewBox='${-2} ${-2} ${w-sizeInc+4} ${w-sizeInc+4}'><path class='lines' d='${coords}'/></svg>`;
}
...
function createQuadraticCurveVertices(order,coordsObject,id,classes) {
  ...
  return `<svg id='quadvertex-${order}-${id}' class='order-x pad ${classes} l${totalLength}' viewBox='${-2} ${-2} ${w-sizeInc+4} ${w-sizeInc+4}'><path class='lines' d='${coords}'/></svg>`;
}
...
function createQuadraticCurveLines(order,coordsObject,id,classes) {
  ...
  return `<svg id='quadline-${order}-${id}' class='order-x pad ${classes} l${totalLength}' viewBox='${-2} ${-2} ${w-sizeInc+4} ${w-sizeInc+4}'><path class='lines' d='${coords}'/></svg>`;
}
...
function createArc(order,coordsObject,id,classes) {
  ...
  return `<svg id='arc-${order}-${id}' class='order-x ${classes} l${totalLength}' viewBox='${-200} ${-170} ${w-sizeInc+380} ${w-sizeInc+380}'><path class='lines arc' d='${coords}'/></svg>`;
}
...
function createArcAlt(order,coordsObject,id,classes) {
  ...
  return `<svg id='altarc-${order}-${id}' class='order-x ${classes} l${totalLength}' viewBox='${-200} ${-170} ${w-sizeInc+380} ${w-sizeInc+380}'><path class='lines arc' d='${coords}'/></svg>`;
}
...
function createCirclesSVGs(order,coordsObject,id,classes) {
  ...
  return `<svg id='circles-${order}-${id}' class='order-xt pad ${classes}' viewBox='-40 -40 380 380'>${blobs}</svg>`;
}
...
function createTetrominoSVGs(order,coordsObject,id,classes) {
  ...
  return `<svg id='tetromino-${order}-${id}' class='order-xt pad ${classes}' viewBox='${-50} ${-50} ${w+50} ${w+50}'>${blobs}</svg>`;
}
...
function createBlocksSVGs(order,coordsObject,id,classes) {
  ...
  // return `<svg id='colours-${order}-${id}' class='order-xt pad' viewBox='${-200} ${-170} ${w-sizeInc+380} ${w-sizeInc+380}'>${blobs}</svg>`;
  return `<svg id='blocks-${order}-${id}' class='order-xt pad ${classes}' viewBox='${0} ${0} ${w} ${w}'>${blobs}</svg>`;
}

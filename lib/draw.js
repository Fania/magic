...
function createPolyline(order,coordsObject,id,classes) {
  ...
  return `<svg id='straight-${order}-${id}' class='${classes} l${totalLength}' viewBox='${-2} ${-2} ${w-sizeInc+4} ${w-sizeInc+4}'><path d='${coords}'/></svg>`;
}
...
function createQuadraticCurveVertices(order,coordsObject,id,classes) {
  ...
  return `<svg id='quadvertex-${order}-${id}' class='${classes} l${totalLength}' viewBox='${-2} ${-2} ${w-sizeInc+4} ${w-sizeInc+4}'><path d='${coords}'/></svg>`;
}
...
function createQuadraticCurveLines(order,coordsObject,id,classes) {
  ...
  return `<svg id='quadline-${order}-${id}' class='${classes} l${totalLength}' viewBox='${-2} ${-2} ${w-sizeInc+4} ${w-sizeInc+4}'><path d='${coords}'/></svg>`;
}
...
function createArc(order,coordsObject,id,classes) {
  ...
  return `<svg id='arc-${order}-${id}' class='${classes} l${totalLength}' viewBox='${-200} ${-170} ${w-sizeInc+380} ${w-sizeInc+380}'><path d='${coords}'/></svg>`;
}
...
function createArcAlt(order,coordsObject,id,classes) {
  ...
  return `<svg id='altarc-${order}-${id}' class='${classes} l${totalLength}' viewBox='${-200} ${-170} ${w-sizeInc+380} ${w-sizeInc+380}'><path d='${coords}'/></svg>`;
}
...
function createCirclesSVGs(order,coordsObject,id,classes) {
  ...
  for (let a in coordsObject) {
    ...
    blobs += `<circle cx='${coordsObject[a][0] * 100}' cy='${coordsObject[a][1] * 100}' r='40' fill='${randCol}' stroke='${randCol}' />`;
  }
...
function tetromino(n,dRoot,coordsObject) {
  switch(dRoot) {
    case 1:
      return `<path stroke='${tetroCols[0]}' fill='${tetroCols[0]}' d='M${coordsObject[n][0] * 100},${coordsObject[n][1] * 100} h50 v50 h-50 z'/>`
    case 2:
      return `<path stroke='${tetroCols[1]}' fill='${tetroCols[1]}' d='M${coordsObject[n][0] * 100},${coordsObject[n][1] * 100} h100 v50 h-100 z'/>`
    case 3:
      return `<path stroke='${tetroCols[2]}' fill='${tetroCols[2]}' d='M${coordsObject[n][0] * 100},${coordsObject[n][1] * 100} h50 v100 h-50 z'/>`
    case 4:
      return `<path stroke='${tetroCols[3]}' fill='${tetroCols[3]}' d='M${(coordsObject[n][0] * 100)-50},${(coordsObject[n][1] * 100)-50} h100 v50 h-50 v50 h-50 z'/>`
    case 5:
      return `<path stroke='${tetroCols[4]}' fill='${tetroCols[4]}' d='M${(coordsObject[n][0] * 100)},${(coordsObject[n][1] * 100)-50} h50 v50 h50 v100 h-50 v-50 h-50 z'/>`
    case 6:
      return `<path stroke='${tetroCols[5]}' fill='${tetroCols[5]}' d='M${(coordsObject[n][0] * 100)},${(coordsObject[n][1] * 100)} v-50 h100 v50 h-50 v50 h-100 v-50 z'/>`
    case 7:
      return `<path stroke='${tetroCols[6]}' fill='${tetroCols[6]}' d='M${(coordsObject[n][0] * 100)-50},${(coordsObject[n][1] * 100)} h100 v-50 h50 v100 h-150 z'/>`
    case 8:
      return `<path stroke='${tetroCols[7]}' fill='${tetroCols[7]}' d='M${(coordsObject[n][0] * 100)},${(coordsObject[n][1] * 100)} h100 v100 h-100 z'/>`
    case 9:
      return `<path stroke='${tetroCols[8]}' fill='${tetroCols[8]}' d='M${(coordsObject[n][0] * 100)-50},${(coordsObject[n][1] * 100)-50} h100 v50 h-50 v50 h-50 z'/>`
  }

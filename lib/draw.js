...
function createPolyline(order,coordsObject,id,classes) {
  ...
  return `<svg id='straight-${order}-${id}' class='order-x pad ${classes}' viewBox='${-2} ${-2} ${w-sizeInc+4} ${w-sizeInc+4}'><path class='lines' d='${coords}'/></svg>`;
}
...
function createQuadraticCurveVertices(order,coordsObject,id,classes) {
  ...
  return `<svg id='quadvertex-${order}-${id}' class='order-x pad ${classes}' viewBox='${-2} ${-2} ${w-sizeInc+4} ${w-sizeInc+4}'><path class='lines' d='${coords}'/></svg>`;
}
...
function createQuadraticCurveLines(order,coordsObject,id,classes) {
  ...
  return `<svg id='quadline-${order}-${id}' class='order-x pad ${classes}' viewBox='${-2} ${-2} ${w-sizeInc+4} ${w-sizeInc+4}'><path class='lines' d='${coords}'/></svg>`;
}
...
function createArc(order,coordsObject,id,classes) {
  ...
  return `<svg id='arc-${order}-${id}' class='order-x ${classes}' viewBox='${-200} ${-170} ${w-sizeInc+380} ${w-sizeInc+380}'><path class='lines arc' d='${coords}'/></svg>`;
}
...
function createArcAlt(order,coordsObject,id,classes) {
  ...
  return `<svg id='altarc-${order}-${id}' class='order-x ${classes}' viewBox='${-200} ${-170} ${w-sizeInc+380} ${w-sizeInc+380}'><path class='lines arc' d='${coords}'/></svg>`;
}

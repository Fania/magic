...
// }
    ...
    if (result.magic) {
      ...
      const numberSVG = draw.prepareSVG(result.order,'numbers',coordsObject,0)
      result.numberSVG = numberSVG
      const quadvertexSVG = draw.prepareSVG(result.order,'quadvertex',coordsObject,0)
      result.quadvertexSVG = quadvertexSVG
      const quadlineSVG = draw.prepareSVG(result.order,'quadline',coordsObject,0)
      result.quadlineSVG = quadlineSVG
      const arcSVG = draw.prepareSVG(result.order,'arc',coordsObject,0)
      result.arcSVG = arcSVG
      const altarcSVG = draw.prepareSVG(result.order,'altarc',coordsObject,0)
      result.altarcSVG = altarcSVG
      const straightSVG = draw.prepareSVG(result.order,'straight',coordsObject,0)
